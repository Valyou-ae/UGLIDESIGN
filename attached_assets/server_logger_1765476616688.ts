...
// Check if we should output JSON format (useful for log aggregation)
...
// Format human-readable timestamp for console
...
const logMessage = (
  ...
  if (useJsonFormat()) {
    ...
    // Remove source from context to avoid duplication
