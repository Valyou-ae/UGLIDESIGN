/**
 * CAMERA SPECIFICATIONS & PRODUCT ANGLE KNOWLEDGE BASE
 * 
 * Defines camera settings, lens characteristics, and technical specifications
 * for different product photography styles and angles.
 */

import { MockupAngle } from '../../types';
...
export interface CameraSpec {
  ...
  sensorDistance: string; // feet/meters
  fieldOfView: string;
  depthOfField: string;
  perspective: string;
