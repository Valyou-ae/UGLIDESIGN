...
interface EthnicFeatures {
    hairColors: string[];
    eyeColors: string[];
    hairStyles: string[];
}

const ETHNIC_FEATURE_MAP: Record<Ethnicity, EthnicFeatures> = {
    'White': {
    ...
    'Southeast Asian': {
        hairColors: ['jet black', 'dark brown'],
        eyeColors: ['dark brown', 'deep brown'],
