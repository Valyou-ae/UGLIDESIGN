  ...
  return (
    <div className="min-h-screen w-full flex bg-background text-foreground overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-black items-center justify-center overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-[#374151]">
          <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-[#EC4899]/20 rounded-full blur-[120px]" />
          <div className="absolute bottom-[-20%] right-[-10%] w-[70%] h-[70%] bg-[#A855F7]/20 rounded-full blur-[120px]" />
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 right-1/4 w-24 h-24 bg-gradient-to-br from-[#A855F7] to-[#9333EA] rounded-2xl opacity-20 blur-2xl animate-float" />
          <div className="absolute bottom-1/3 left-1/4 w-32 h-32 bg-gradient-to-br from-[#EC4899] to-[#DB2777] rounded-full opacity-20 blur-3xl animate-float-delayed" />
        </div>
      </div>
        ...
        <div className="w-full max-w-[440px] space-y-8">
          ...
          {error && !isSuccess ? (
            ...
            >
              ...
              <Button 
                className="w-full h-11 rounded-xl bg-gradient-to-r from-[#EC4899] to-[#DB2777] hover:brightness-110 text-white font-bold"
                onClick={() => setLocation("/")}
            ...
            <div className="grid gap-6">
              <form onSubmit={handleReset} className="grid gap-4">
                ...
                <Button 
                  ...
                  className="h-11 rounded-xl bg-gradient-to-r from-[#EC4899] to-[#DB2777] hover:brightness-110 text-white font-bold shadow-lg shadow-[#EC4899]/20 transition-all hover:-translate-y-[1px]"
