              ...
              <AnimatePresence>
                {showTransferBanner && uploadedImage && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 20 }}
                    className="mt-6 md:mt-8 w-full max-w-[900px] bg-gradient-to-r from-[#B94E30]/10 via-[#E3B436]/10 to-[#B94E30]/10 border border-[#B94E30]/30 rounded-2xl p-4"
                  >
                    <div className="flex items-center gap-4">
                      <div className="h-16 w-16 md:h-20 md:w-20 rounded-xl border-2 border-[#B94E30] overflow-hidden bg-white/10 flex-shrink-0 shadow-lg">
                        <img src={uploadedImage} alt="Transferred design" className="h-full w-full object-contain" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <CheckCircle2 className="h-5 w-5 text-[#B94E30]" />
