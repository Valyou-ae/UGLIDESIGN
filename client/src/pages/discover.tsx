                  ...
                  <PopoverContent className="w-48 p-2" align="end" onClick={(e) => e.stopPropagation()}>
                    <div className="flex flex-col gap-1">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-[#1DA1F2]/10 transition-colors text-left"
                        data-testid={`button-share-twitter-${item.id}`}
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-[#1877F2]/10 transition-colors text-left"
                        data-testid={`button-share-facebook-${item.id}`}
                      >
                        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-[#25D366]/10 transition-colors text-left"
                        data-testid={`button-share-whatsapp-${item.id}`}
                      >
                        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
