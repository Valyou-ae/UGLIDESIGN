        ...
        <div className="p-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className={cn(
                "flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#f06595] to-[#b83dba] text-white rounded-full font-semibold text-sm hover:shadow-lg hover:shadow-[#ed5387]/40 transition-shadow",
